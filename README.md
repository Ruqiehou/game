...
| 文件 | 作用 |
|------|------|
| `ck_engine/ui/server.py` | 本地 HTTP 服务（8765） |
| `ck_engine/ui/api.py` | 状态快照与玩家指令 |
| `ck_engine/ui/map_layout.py` | 省份坐标与多边形 |
| `ck_engine/ui/static/` | 前端 HTML/CSS/JS |

支持：切换玩家、推进时间、选省/军团、征召/行军/解散、宣战、改善关系、宴会、存档/读档、新局。  
推进时间时 **跳过玩家角色的 AI**，由你手动操作。
